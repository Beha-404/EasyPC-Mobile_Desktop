...
public class ProcessorService(DatabaseContext context, IMapper mapper, BaseProcessorStateMachine stateMachine, IHttpContextAccessor httpContextAccessor) : BaseService<Model.Processor, ProcessorSearchObject, ProcessorInsertRequest, ProcessorUpdateRequest, Processor, BaseProcessorStateMachine>(context, mapper, stateMachine, httpContextAccessor), IProcessorService
{

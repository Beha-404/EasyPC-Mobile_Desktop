...
public class ManufacturerService(DatabaseContext context, IMapper mapper) : IManufacturerService
{
    ...
    public IQueryable<Manufacturer> ApplyFilters(IQueryable<Manufacturer> query, ManufacturerSearchObjects searchObjects)
    {
    ...
    public Model.Manufacturer? Insert(ManufacturerInsertRequest insertRequest)
    {
        ...
        var entity = _mapper.Map<Manufacturer>(insertRequest);

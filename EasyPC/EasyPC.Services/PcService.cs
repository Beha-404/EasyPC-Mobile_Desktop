...
public class PcService(DatabaseContext context, IMapper mapper, BasePcStateMachine stateMachine, IHttpContextAccessor httpContextAccessor, IMemoryCache cache) : BaseService<Model.PC, PcSearchObject, PcInsertRequest, PcUpdateRequest, Database.PC, BasePcStateMachine>(context, mapper, stateMachine, httpContextAccessor), IPcService
{

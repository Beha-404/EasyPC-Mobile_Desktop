...
public class PowerSupplyService(DatabaseContext context, IMapper mapper, BasePowerSupplyStateMachine stateMachine, IHttpContextAccessor httpContextAccessor) : BaseService<Model.PowerSupply, PowerSupplySearchObject, PowerSupplyInsertRequest, PowerSuplyUpdateRequest, PowerSupply, BasePowerSupplyStateMachine>(context, mapper, stateMachine, httpContextAccessor), IPowerSupplyService
{

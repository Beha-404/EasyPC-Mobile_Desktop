...
public class BaseService<Tmodel, TSearch, TInsert, TUpdate, TEntity, TStateMachine>(DatabaseContext context, IMapper mapper, TStateMachine stateMachine, IHttpContextAccessor httpContextAccessor) : IBaseService<Tmodel, TSearch, TInsert, TUpdate> where TSearch : BaseSearchObject
where TEntity : class
where TStateMachine : IBaseStateMachine<Tmodel, TInsert, TUpdate, TEntity>
{
    ...
    protected TStateMachine _stateMachine = stateMachine;

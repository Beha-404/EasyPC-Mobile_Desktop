...
public class BuildWizardController(BuildWizardService buildWizardService) : ControllerBase
{
    private readonly BuildWizardService _buildWizardService = buildWizardService;
